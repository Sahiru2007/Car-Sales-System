...
namespace Car_trading_system.DataSets {
    ...
    public partial class Order : global::System.Data.DataSet {
        ...
        public partial class OrderDataTable : global::System.Data.TypedTableBase<OrderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrderRow AddOrderRow(string CustomerID, string ProductID, int Quantity, decimal Amount, System.DateTime OrderDate, string Status, string PaymentStatus) {
            ...
            private void InitClass() {
                ...
                this.ExtendedProperties.Add("Generator_TablePropName", "_Order");
...
namespace Car_trading_system.DataSets.OrderTableAdapters {
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Order] WHERE (([OrderID] = @Original_OrderID) AND ((@IsNull_CustomerID = 1 AND [CustomerID] IS NULL) OR ([CustomerID] = @Original_CustomerID)) AND ((@IsNull_ProductID = 1 AND [ProductID] IS NULL) OR ([ProductID] = @Original_ProductID)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_OrderDate = 1 AND [OrderDate] IS NULL) OR ([OrderDate] = @Original_OrderDate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_PaymentStatus = 1 AND [PaymentStatus] IS NULL) OR ([PaymentStatus] = @Original_PaymentStatus)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Order] ([CustomerID], [ProductID], [Quantity], [Amount], [OrderDate], [Status], [PaymentStatus]) VALUES (@CustomerID, @ProductID, @Quantity, @Amount, @OrderDate, @Status, @PaymentStatus);
SELECT OrderID, CustomerID, ProductID, Quantity, Amount, OrderDate, Status, PaymentStatus FROM [Order] WHERE (OrderID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Order] SET [CustomerID] = @CustomerID, [ProductID] = @ProductID, [Quantity] = @Quantity, [Amount] = @Amount, [OrderDate] = @OrderDate, [Status] = @Status, [PaymentStatus] = @PaymentStatus WHERE (([OrderID] = @Original_OrderID) AND ((@IsNull_CustomerID = 1 AND [CustomerID] IS NULL) OR ([CustomerID] = @Original_CustomerID)) AND ((@IsNull_ProductID = 1 AND [ProductID] IS NULL) OR ([ProductID] = @Original_ProductID)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_OrderDate = 1 AND [OrderDate] IS NULL) OR ([OrderDate] = @Original_OrderDate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_PaymentStatus = 1 AND [PaymentStatus] IS NULL) OR ([PaymentStatus] = @Original_PaymentStatus)));
SELECT OrderID, CustomerID, ProductID, Quantity, Amount, OrderDate, Status, PaymentStatus FROM [Order] WHERE (OrderID = @OrderID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Car_trading_system.Properties.Settings.Default.CarDealershipDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT OrderID, CustomerID, ProductID, Quantity, Amount, OrderDate, Status, Payme" +
                "ntStatus FROM dbo.[Order]";
        ...
        public virtual int Fill(Order.OrderDataTable dataTable) {
        ...
        public virtual Order.OrderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Order.OrderDataTable dataTable = new Order.OrderDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Order.OrderDataTable dataTable) {
        ...
        public virtual int Delete(int Original_OrderID, string Original_CustomerID, string Original_ProductID, global::System.Nullable<int> Original_Quantity, global::System.Nullable<decimal> Original_Amount, global::System.Nullable<global::System.DateTime> Original_OrderDate, string Original_Status, string Original_PaymentStatus) {
        ...
        public virtual int Insert(string CustomerID, string ProductID, global::System.Nullable<int> Quantity, global::System.Nullable<decimal> Amount, global::System.Nullable<global::System.DateTime> OrderDate, string Status, string PaymentStatus) {
            if ((CustomerID == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerID, string ProductID, global::System.Nullable<int> Quantity, global::System.Nullable<decimal> Amount, global::System.Nullable<global::System.DateTime> OrderDate, string Status, string PaymentStatus, int Original_OrderID, string Original_CustomerID, string Original_ProductID, global::System.Nullable<int> Original_Quantity, global::System.Nullable<decimal> Original_Amount, global::System.Nullable<global::System.DateTime> Original_OrderDate, string Original_Status, string Original_PaymentStatus) {
            return this.Update(CustomerID, ProductID, Quantity, Amount, OrderDate, Status, PaymentStatus, Original_OrderID, Original_CustomerID, Original_ProductID, Original_Quantity, Original_Amount, Original_OrderDate, Original_Status, Original_PaymentStatus, Original_OrderID);
        }
    }
